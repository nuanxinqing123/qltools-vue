...
<!--        变量管理-->
        <div class="mdui-card mt" style="border-radius:15px;margin-top: 15px;">
            <div class="mdui-card-primary">
                <div class="mdui-card-primary-title">Set Env</div>
            </div>
                ...
                <table class="mdui-table mdui-table-hoverable">
                    ...
                    <tbody>
                        <tr v-for="d in EnvAll" :key="d">
                            ...
                            <th>{{d.Regex}}</th>
                            <th>
                                <button @click="OpenEnvUpdate(d.ID, d.Name, d.Quantity, d.Regex)" class="mdui-btn mdui-btn-dense mdui-btn-raised btn mdui-p-x-1 mdui-color-blue mdui-text-color-white">
                                    修改
                                </button>
                                &ensp;&ensp;
...
export default {
    ...
    methods: {
        ...
        OpenEnvUpdate(id, name, quantity, regex){
